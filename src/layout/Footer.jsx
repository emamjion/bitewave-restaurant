...
const footer1 = [
  {
    description:
      "Order delicious food quickly and easily with Bitwave. Enjoy seamless navigation, secure payments, and fast delivery for a hassle-free experience.",
  ...
  return (
    <footer className="footer-bg">
      <div className="container mx-auto">
        <div className="py-[65px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-5">
              ...
              {footer1.map((item, index) => {
                return (
                  <div key={index} className="">
                    <p className="lg:max-w-[330px] mb-4 text-white">
                      {item.description}
                    </p>
          ...
          <div className=" lg:pl-10">
            <div className="mb-4">
              <h1 className="text-xl font-semibold text-white py-2.5">
                Quick links
              </h1>
          ...
          <div>
            ...
            <div className="w-[270px] grid grid-cols-3 gap-4">
              {instagram.map((img, index) => {
                return (
                  <div key={index} className="max-w-[78px] max-h-[80px]">
          ...
          <div>
            ...
            <div>
              <p className="lg:max-w-[330px] mb-5 text-white">
                Subscribe for exclusive deals, menu updates, and priority
                delivery on Bitwave.
              </p>
              <form className="relative flex items-center">
                <Input placeholder="Enter your Email" className="relative" />
              ...
              <div className="text-white flex items-center gap-3 mt-6">
                <span>
                  {" "}
                  <FaFacebookF className="text-2xl hover:text-accent duration-500 cursor-pointer" />{" "}
                </span>
                <span>
                  {" "}
                  <FaTwitter className="text-2xl hover:text-accent duration-500 cursor-pointer" />{" "}
                </span>
                <span>
                  {" "}
                  <FaSkype className="text-2xl hover:text-accent duration-500 cursor-pointer" />{" "}
                </span>
                <span>
                  {" "}
                  <FaInstagram className="text-2xl hover:text-accent duration-500 cursor-pointer" />{" "}
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <p className="py-5 text-center text-white">
          Developed by{" "}
          <Link hrefLang="https://codeclubitsolutions.com/">
